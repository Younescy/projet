--------------Projet Bibliotheque-------------
Etape 1: compiler les fichiers init_user.c et init_livres.c

Etape 2: executer les fichiers init_user.c et init_livres.c

Etape 3: compiler le fichier Emprunter.c

Etape 4: executer le fichier Emprunter.c

BONUS: listing: si vous voulez avoir les infos qui sont dans les bases de données user et livre.
